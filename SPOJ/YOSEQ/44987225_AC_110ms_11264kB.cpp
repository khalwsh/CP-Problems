...
signed main() {
    ...
    string s;
    cin>>s;
    for(int i=0;i<s.size();i++)vis[s[i]-'0']=true;
    for(int i=0;i<s.size()-1;i++)vis[(s[i]-'0')*10+s[i+1]-'0']=true;
    for(int i=0;i<s.size()-2;i++)vis[(s[i]-'0')*100+(s[i+1]-'0')*10+s[i+2]-'0']=true;
    for(int i=0;i<s.size()-3;i++)vis[(s[i]-'0')*1000+(s[i+1]-'0')*100+(s[i+2]-'0')*10+s[i+3]-'0']=true;
    for(int i=0;i<s.size()-4;i++)vis[(s[i]-'0')*10000+(s[i+1]-'0')*1000+(s[i+2]-'0')*100+(s[i+3]-'0')*10+s[i+4]-'0']=true;
    for(int i=0;i<1e6;i++){
        if(!vis[i]){
            cout<<i<<" ";
            exit(0);
