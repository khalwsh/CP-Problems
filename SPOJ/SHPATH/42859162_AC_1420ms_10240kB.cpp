...
int shortest_path(int start,int end,vector<pair<int,int>>adj[],int n)
{
...
signed main() {
    ...
    while(t--)
    {
        ...
        while(r--)
        {
            ...
            string end;
            cin>>start>>end;
            int index_start=mp[start];
            int index_end=mp[end];
            cout<<shortest_path(index_start,index_end,adj,n);
            cout<<line;
        }
    }
}