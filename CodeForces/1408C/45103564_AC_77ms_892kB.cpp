...
bool power_of_two(int n) {return n>0 && !(n & (n - 1));}
...
/*--------------------------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------*/
pair<long double,long double> good(long double m,vector<int>&arr,int ln){
    double t1=0,spd=1;
    int lst = 0;
...
signed main() {
    ...
    while(t--){
        ...
        while(abs(right-left)>eps){
            ...
            pair<long double,long double> a = good(mid,v,l);
            if(abs(a.first-a.second)<=eps){
                cout<<fixed<<showpoint<<setprecision(15)<<a.first<<endl;
                break;
            }
            if(a.first>a.second){
                right = mid;
