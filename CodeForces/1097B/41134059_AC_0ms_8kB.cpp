...
bool rotation(int index,long long value);
int n;
vector<int>work;
int main() {
    khaled
    ...
    if(rotation(1,work[0])|| rotation(1,-work[0]))
        cout<<"YES";
    else
        cout<<"NO";
...
bool rotation(int index,long long value)
{
     ...
     return rotation(index+1,value+work[index])|| rotation(index+1,value-work[index]);
}
