...
int main() {
    ...
    while(t--)
    {
        ...
        for(auto &val:v)
            cin>>val;
        long long my_max=*max_element(v.begin(),v.end());
        long long my_min=*min_element(v.begin(),v.end());
        for(auto &val:v)
        {
            bitset<64>b1(my_max);
            bitset<64>b2(val);
            ...
            my_max=(long long)b1.to_ullong();
            val=(long long)b2.to_ullong();
        }
        for(auto &val:v)
        {
            bitset<64>b1(my_min);
            ...
            my_min=(long long)b1.to_ullong();
            val=(long long)b2.to_ullong();
        }
        cout<<my_max-my_min<<line;
    }
