...
/*--------------------------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------*/
bool increasing(int start,int finish,vector<int>&v){
    for(int i=start+1;i<=finish;i++){
        if(v[i]<v[i-1])return false;
    }
    return true;
}
bool decreasing(int start,int finish,vector<int>&v){
    for(int i=start+1;i<=finish;i++){
        if(v[i]>v[i-1])return false;
    }
    return true;
...
signed main() {
    ...
    cout<<(increasing(0, max_element(v.begin(),v.end())-v.begin(),v)&& decreasing(max_element(v.begin(),v.end())-v.begin(),n-1,v)?
    "YES":"NO")<<line;
}