...
/*--------------------------------------------------------------------------------------------------------------------*/
/*--------------------------------------------------------------------------------------------------------------------*/
/*long long solve(int index,int n,int k,int fixed){
    if(index==n){
        if(fixed>=n-k)return 1;
        else return 0;
    }
    long long res1=solve(index+1,n,k,fixed+1);
    long long res2=solve(index+1,n,k,fixed);
    return res1+res2;
}*/
signed main() {
    khaled
